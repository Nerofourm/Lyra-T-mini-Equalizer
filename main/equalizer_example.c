...
void app_main(void)
{
    ...
    int set_gain[] = {20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20};
    eq_cfg.set_gain =
    ...
    // PODEMOS INTENTAR PARTICIONAR EL CÓDIGO QUITANDO EL EQUALIZER PARA VERIFICAR QUE TODO FUNCIONA COMO DEBERÍA
